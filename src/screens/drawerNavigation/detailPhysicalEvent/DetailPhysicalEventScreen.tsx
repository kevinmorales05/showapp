...
const DetailPhysicalEventScreen = ({route, navigation}) => {
  ...
  const detailEvent = {
    ...
    "photos":[{
        ...
        "imgUrl":"https://www.nacionrex.com/__export/1595098504054/sites/debate/img/2020/07/18/kard-celebra-su-tercer-aniversario_crop1595096837842.jpg_1902800913.jpg"
    },
    {
        "id":2,
    ...
    },
    {
        ...
        "imgUrl":"https://0.soompi.io/wp-content/uploads/sites/8/2018/08/10213634/KARD.png?s=900x600&e=t"
    }]
  }
    ...
    <SafeAreaView key={id} style={{flexDirection: 'column', backgroundColor:'#2E364C'}}>
      ...
      <View
        style={{
          ...
          justifyContent: 'center',
         alignItems:'center',
          marginBottom:moderateScale(50), backgroundColor:'#6C141B', 
          borderRadius:10,
