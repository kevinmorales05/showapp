...
const cuoponsList: Array<couponProps> = [
  ...
  return (
    <View style={styles.mainContainer}>
       <Text style={styles.promoText}>When you are buying add the code of the coupon and enjoy amazing benefits!</Text>
      <ScrollView >
        {
          cuoponsList.map ((coupon: couponProps)=> {
            return <Coupon id={coupon.id} code={coupon.code} name={coupon.name} description={coupon.description} date={coupon.date} hour={coupon.hour} status={coupon.status} img={coupon.img} type={coupon.type} eventType={coupon.eventType} quantity={coupon.quantity} validUntil={coupon.validUntil} />
          })
        }
